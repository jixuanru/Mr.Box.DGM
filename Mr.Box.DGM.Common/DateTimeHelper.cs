...
namespace Mr.Box.DGM.Common
{
    ...
    public class DateTimeHelper
    {
        ...
        /// <param name="dateEnd"></param>
        /// <returns></returns>
        public static int MonthDiff(DateTime dateStart, DateTime dateEnd)
        {
            int month = 0;
            ...
            if (end.Year - start.Year > 0)
            {
                ...
                {
                    month = (end.Year - start.Year - 1) * 12 + (12 - start.Month) + end.Month + 1;
                }
                else
                {
        ...
        {
           return DateTime.ParseExact(time, "yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture);
        }
        #endregion
    }
}
