...
namespace Mr.Box.DGM.Common
{
    ...
    public class Base64Helper
    {
        ...
        protected static Base64Helper SB64 = new Base64Helper();
        ...
        public static Base64Helper GetStandardBase64()
        {
            var b64 = new Base64Helper { Pad = "=", CodeTable = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" };
            return b64;
        }
